package com.example.hcy.chunyuweather.db;
 ...
 */
public class ChunyuWeatherOpenHelper extends SQLiteOpenHelper {
    //Province建表语句
    ...
    public ChunyuWeatherOpenHelper(Context context,String name,SQLiteDatabase.CursorFactory factory,int version){
